namespace backendLibraryManagement.Model
{
    ...
    public class Book
    {
        ...
        public int TotalCopies { get; set; }  // Total number of copies the library owns.
        public int CopiesAvailable { get; set; }  // Number of copies currently available for loan.
        public bool IsAvailable => CopiesAvailable > 0; // Indicates whether the book can be borrowed (CopiesAvailable > 0).
    }
}
